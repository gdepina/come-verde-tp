    ...
    return this.props.currentHits && (
      <div className="Hits">
        <div className="Hits__performance-container">
          <span className="Hits__results-number">{this.props.result.nbHits} resultados encontrados </span>
          <span className="Hits__processing-time">in {this.props.result.processingTimeMS /1000 } segundos</span>
